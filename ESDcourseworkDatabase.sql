...
create table patients(
	...
	PatientType varchar(10),
        ReissuePerscription varchar(10),
...
INSERT INTO Patients (PatientName, PatientAddress, PatientType, ReissuePerscription, UserName) VALUES ('Charly Aidan', '14 King Street, Aberdeen, AB24 1BR', 'NHS', 'yes', 'caidan');
INSERT INTO Patients (PatientName, PatientAddress, PatientType, ReissuePerscription, UserName) VALUES ('Prince Hassan', 'Non-UK street, Non-UK Town, BS15 1QZ', 'private', 'no', 'princehassan');
INSERT INTO Patients (PatientName, PatientAddress, PatientType, ReissuePerscription, UserName) VALUES ('Mohammed Hassan', 'Queen street, Non-UK Town, BS15 1QQ', 'private', 'no', 'mohammed');
INSERT INTO Patients (PatientName, PatientAddress, PatientType, ReissuePerscription, UserName) VALUES ('Chris Waters', 'Prince street, Bristol, BS1 1AA', 'private', 'no', 'chris');
...
INSERT INTO booking_slots (EmployeeID, PatientID, SlotDate, SlotTime) VALUES (1,2, '2020-01-01', '13:00');
INSERT INTO booking_slots (EmployeeID, PatientID, SlotDate, SlotTime) VALUES (2,4,'2019-11-13', '14:00');
INSERT INTO booking_slots (EmployeeID, PatientID, SlotDate, SlotTime) VALUES (4,3,'2020-05-04', '10:00');
INSERT INTO booking_slots (EmployeeID, PatientID, SlotDate, SlotTime) VALUES (3,1,'2019-12-30', '20:00');
